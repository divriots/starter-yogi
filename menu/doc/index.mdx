import { ChevronDownIcon, HamburgerIcon, AddIcon, ExternalLinkIcon, RepeatIcon, EditIcon } from "../src/index";
import { MenuButton, MenuList, MenuItem, MenuDivider, Portal, MenuGroup, MenuOptionGroup, MenuItemOption } from "../src/index";
...
<Playground
scope={{ Menu, MenuButton, Button, ChevronDownIcon, MenuList, MenuItem, Image }}
code={`
<Menu>
  <MenuButton as={Button} rightIcon={<ChevronDownIcon />}>
    Your Cats
...
<Playground
scope={{ Menu, MenuButton, IconButton, HamburgerIcon, MenuList, MenuItem, AddIcon, ExternalLinkIcon, RepeatIcon, EditIcon }}
code={`
<Menu>
  <MenuButton
    as={IconButton}
...
<Playground
scope={{ Menu, MenuButton, Button, MenuList, MenuGroup, MenuItem, MenuDivider }}
code={`
<Menu>
...
<Playground
scope={{ Menu, MenuButton, Button, MenuList, MenuOptionGroup, MenuItemOption, MenuDivider }}
code={`
