...
import { Menu, MenuButton, MenuList, MenuItem, MenuDivider, Image, Portal, MenuGroup, MenuOptionGroup, MenuItemOption } from "@chakra-ui/react";
...
<Playground
scope={{ Menu, MenuButton, ChevronDownIcon, MenuList, MenuItem }}
code={`
<Menu>
...
<Playground
scope={{ Menu, MenuButton, ChevronDownIcon, MenuList, MenuItem, Image }}
code={`
<Menu>
  <MenuButton as={Button} rightIcon={<ChevronDownIcon />}>
    Your Cats
...
<Playground
scope={{ Menu, MenuButton, HamburgerIcon, MenuList, MenuItem, AddIcon, ExternalLinkIcon, RepeatIcon, EditIcon }}
code={`
<Menu>
  <MenuButton
    as={IconButton}
...
<Playground
scope={{ Menu, MenuButton, MenuList, MenuGroup, MenuItem, MenuDivider }}
code={`
<Menu>
...
<Playground
scope={{ Menu, MenuButton, MenuList, MenuOptionGroup, MenuItemOption, MenuDivider }}
code={`
