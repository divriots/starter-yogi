import { NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Stack, Flex, Slider, SliderTrack, SliderFilledTrack, SliderThumb, HStack, Button, Input } from "@chakra-ui/react";
...
<Playground
scope={{ NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper }}
code={`
<NumberInput>
  <NumberInputField />
  <NumberInputStepper>
...
<Playground
scope={{ Stack, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper }}
code={`
...
<Playground
scope={{ Flex, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Slider, SliderTrack, SliderFilledTrack, SliderThumb }}
code={`
