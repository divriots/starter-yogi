...
import { Popover, PopoverTrigger, Button, PopoverContent, PopoverArrow, PopoverCloseButton, PopoverHeader, PopoverBody, Portal, PopoverFooter, Box, ButtonGroup, FormControl, FormLabel, Input, Stack, TextInput, useDisclosure, IconButton, FocusLock, Form, PopoverForm } from "@chakra-ui/react";
...
<Playground
scope={{ Popover, PopoverTrigger, Button, PopoverContent, PopoverArrow, PopoverCloseButton, PopoverHeader, PopoverBody }}
code={`
<Popover>
  <PopoverTrigger>
...
<Playground
scope={{ Popover, PopoverTrigger, Button, Portal, PopoverContent, PopoverArrow, PopoverHeader, PopoverCloseButton, PopoverBody, PopoverFooter }}
code={`
<Popover>
  <PopoverTrigger>
    <Button>Trigger</Button>
...
<Playground
scope={{ Popover, PopoverTrigger, Button, PopoverContent, PopoverHeader, PopoverArrow, PopoverCloseButton, PopoverBody, PopoverFooter, Box, ButtonGroup }}
code={`
...
<Playground
scope={{ FormControl, FormLabel, Input, Stack, TextInput, ButtonGroup, Button, useDisclosure, Box, Popover, PopoverTrigger, IconButton, EditIcon, PopoverContent, FocusLock, PopoverArrow, PopoverCloseButton, Form, PopoverForm }}
code={`
...
<Playground
scope={{ Button, Popover, PopoverTrigger, PopoverContent, PopoverHeader, PopoverArrow, PopoverCloseButton, PopoverBody, PopoverFooter, ButtonGroup }}
code={`
...
<Playground
scope={{ Popover, PopoverTrigger, Button, Portal, PopoverContent, PopoverHeader, PopoverCloseButton, PopoverBody, Box, PopoverFooter }}
code={`
...
<Playground
scope={{ Popover, PopoverTrigger, Box, PopoverContent, PopoverHeader, PopoverArrow, PopoverCloseButton, PopoverBody }}
code={`
<Popover>
  <PopoverTrigger>
    <Box
...
<Playground
scope={{ Popover, PopoverTrigger, Button, PopoverContent, PopoverHeader, PopoverArrow, PopoverCloseButton, PopoverBody }}
code={`
