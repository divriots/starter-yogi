import { RadioGroup, Stack, Radio, useRadio, Box, useRadioGroup, HStack, RadioCard, Example } from "@chakra-ui/react";
...
<Playground
scope={{ useRadio, Box, useRadioGroup, HStack, RadioCard, Example }}
code={`
// 1. Create a component that consumes the \`useRadio\` hook
