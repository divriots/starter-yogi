...
import { Editable, EditablePreview, EditableInput, ButtonGroup, IconButton, Flex, EditableControls } from "@chakra-ui/react";
...
<Playground
scope={{ ButtonGroup, IconButton, CheckIcon, CloseIcon, Flex, EditIcon, Editable, EditablePreview, EditableInput, EditableControls }}
code={`
