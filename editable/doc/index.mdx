...
import { Editable, EditablePreview, EditableInput,  useEditableControls, ButtonGroup, IconButton, Flex, EditableControls } from "@chakra-ui/react";
...
<Playground
scope={{  useEditableControls, ButtonGroup, IconButton, CheckIcon, CloseIcon, Flex, EditIcon, Editable, EditablePreview, EditableInput, EditableControls }}
code={`
