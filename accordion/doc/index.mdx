import { MinusIcon, AddIcon } from "../src/index";
import { AccordionItem, AccordionButton, AccordionIcon, AccordionPanel } from "../src/index";
...
<Playground
scope={{ Accordion, AccordionItem, AccordionButton, Box, AccordionIcon, AccordionPanel }}
code={`
<Accordion>
  <AccordionItem>
    <h2>
...
<Playground
scope={{ Accordion, AccordionItem, AccordionButton, Box, AccordionIcon, AccordionPanel, MinusIcon, AddIcon }}
code={`
