import { Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter, Box, Text, FormControl, FormLabel, Input, RadioGroup, Stack, Radio } from "@chakra-ui/react";
...
<Playground
scope={{ Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
function BasicUsage() {
...
<Playground
scope={{ Box, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
...
<Playground
scope={{ Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Text, Lorem, ModalFooter }}
code={`
function BasicUsage() {
  const { isOpen, onOpen, onClose } = useDisclosure()
  return (
...
<Playground
scope={{ Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, FormControl, FormLabel, Input, ModalFooter }}
code={`
...
<Playground
scope={{ RadioGroup, Stack, Radio, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
