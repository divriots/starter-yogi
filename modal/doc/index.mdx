import { useDisclosure, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter, Box, Text, FormControl, FormLabel, Input, RadioGroup, Stack, Radio } from "@chakra-ui/react";
...
<Playground
scope={{ useDisclosure, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
function BasicUsage() {
...
<Playground
scope={{ useDisclosure, Box, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
...
<Playground
scope={{ useDisclosure, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Text, Lorem, ModalFooter }}
code={`
function BasicUsage() {
  const { isOpen, onOpen, onClose } = useDisclosure()
  return (
...
<Playground
scope={{ useDisclosure, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, FormControl, FormLabel, Input, ModalFooter }}
code={`
...
<Playground
scope={{ useDisclosure, RadioGroup, Stack, Radio, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Lorem, ModalFooter }}
code={`
