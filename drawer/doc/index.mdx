...
import { Button, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, Input, DrawerFooter, RadioGroup, Stack, Radio, Box, FormLabel, InputGroup, InputLeftAddon, InputRightAddon, Select, Textarea } from "@chakra-ui/react";
...
<Playground
scope={{ Button, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, Input, DrawerFooter }}
code={`
...
<Playground
scope={{ RadioGroup, Stack, Radio, Button, Drawer, DrawerOverlay, DrawerContent, DrawerHeader, DrawerBody }}
code={`
...
<Playground
scope={{ Button, AddIcon, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, Stack, Box, FormLabel, Input, InputGroup, InputLeftAddon, InputRightAddon, Select, Textarea, DrawerFooter }}
code={`
function DrawerExample() {
  const { isOpen, onOpen, onClose } = useDisclosure()
...
<Playground
scope={{ Button, Drawer, DrawerOverlay, DrawerContent, DrawerHeader, DrawerBody }}
code={`
