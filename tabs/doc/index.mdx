import { Tabs, TabList, Tab, TabPanels, TabPanel, Image, Box, StyledTab, CustomTab, DataTabs } from "@chakra-ui/react";
...
<Playground
scope={{ StyledTab, Box, Tabs, TabList, CustomTab, TabPanels, TabPanel }}
code={`
function CustomTabs() {
