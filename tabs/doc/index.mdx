import { Tabs, TabList, Tab, TabPanels, TabPanel, useColorModeValue, Image, Box, useTab, useStyles, StyledTab, CustomTab, DataTabs } from "@chakra-ui/react";
...
<Playground
scope={{ useTab, useStyles, StyledTab, Box, Tabs, TabList, CustomTab, TabPanels, TabPanel }}
code={`
function CustomTabs() {
...
<Playground
scope={{ Tabs, TabList, Tab, TabPanels, TabPanel, DataTabs }}
code={`
function Example() {
