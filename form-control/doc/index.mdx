import { FormControl, FormLabel, Input, FormHelperText, RadioGroup, HStack, Radio, Select, NumberInput, NumberInputField, NumberInputStepper, NumberIncrementStepper, NumberDecrementStepper, Formik, Form, Field, FormErrorMessage, Button } from "@chakra-ui/react";
...
<Playground
scope={{ Formik, Form, Field, FormControl, FormLabel, Input, FormErrorMessage, Button }}
code={`
